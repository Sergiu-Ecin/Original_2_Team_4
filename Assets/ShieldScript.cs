...
public class ShieldScript : MonoBehaviour
{
    ...
    [SerializeField] float costoMetàVita;
    ...
    public void RimuoviVita()
    {
        ...
        if (vitaAttuale == 10)
        {
            ...
            shieldMid.SetActive(false);
            shieldDown.SetActive(false);
            Debug.Log("La vita attuale � di: " + vitaAttuale);
        }
        if (vitaAttuale == 4)
        {
    ...
    public void Ripara()
    {
        ...
        if (vitaAttuale > 0 && iM.money >= costoMetàVita)
        {
            iM.money -= costoMetàVita;
            shieldFull.SetActive(false);
            shieldMid.SetActive(true);
            shieldDown.SetActive(false);
            Debug.Log("Hai Curato di 5, la vita � di: " + vitaAttuale);
